 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |Enc   | LALT |Space | LGUI | Lower|  | Enter| Space| [ {  | ] }  |Raise |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT,              KC_Z,   KC_X,   KC_C,   KC_V,    KC_B, KC_BSPC, MO(_RAISE), KC_LCTL, KC_ESC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MO(_LOWER),
                                      ENC_MODE_L,  KC_LALT,  KC_SPC, KC_LGUI, KC_ENT,   KC_ENT, MO(_RAISE), KC_LBRC, KC_RBRC, KC_EQL
    ),
/*
 ...
 */
    [_LOWER] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, KC_BSLS, KC_DEL, _______, _______, _______, KC_PGDN, KC_HOME, KC_DOWN, KC_END, S(KC_SLSH), _______,
